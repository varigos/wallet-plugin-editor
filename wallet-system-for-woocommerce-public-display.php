...
<div class="wps_wcb_wallet_display_wrapper">
	<div class="wps_wcb_wallet_display_wrapper_with_qr">
		<div class="wps_wcb_wallet_balance_container"> 
            	<label for="wps_wallet_recharge_amount"><?php echo esc_html__( ' your Currency (', 'wallet-system-for-woocommerce' ) . esc_html( get_woocommerce_currency_symbol( $current_currency ) ) . '):'; ?></label>
